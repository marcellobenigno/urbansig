!function (e) {
    ...
    var n = r(4), o = r(38), i = r(39), s = "[object Null]", a = "[object Undefined]", u = n ? n.toStringTag : void 0;
    ...
    function n(e, t, r) {
        ...
        n && function (e) {
            ...
            e.forEach(function (e) {
                if (!u(e)) throw new Error("bbox must only contain numbers")
            })
        }(n), o && function (e) {
    ...
    function i(e, t, r) {
        ...
        if (!u(e[0][1]) || !u(e[0][1])) throw new Error("coordinates must contain numbers");
    ...
    var n = r(11), o = "object" == typeof self && self && self.Object === Object && self,
    ...
    var n = r(0), o = r(2), i = "[object AsyncFunction]", s = "[object Function]", a = "[object GeneratorFunction]",
        u = "[object Proxy]";
    e.exports = function (e) {
        if (!o(e)) return !1;
        var t = n(e);
    ...
    var n = r(51), o = r(52), i = r(19), s = r(54), a = r(17), u = r(56), l = Object.prototype.hasOwnProperty;
    e.exports = function (e, t) {
        var r = i(e), c = !r && o(e), p = !r && !c && s(e), f = !r && !c && !p && u(e), h = r || c || p || f,
            d = h ? n(e.length, String) : [], m = d.length;
        for (var y in e) !t && !l.call(e, y) || h && ("length" == y || p && ("offset" == y || "parent" == y) || f && ("buffer" == y || "byteLength" == y || "byteOffset" == y) || a(y, m)) || d.push(y);
        return d
    }
}, function (e, t) {
    var r = Array.isArray;
    ...
    var n = r(0), o = r(1), i = r(63), s = "[object DOMException]", a = "[object Error]";
    e.exports = function (e) {
        if (!o(e)) return !1;
        var t = n(e);
        return t == a || t == s || "string" == typeof e.message && "string" == typeof e.name && !i(e)
    }
}, function (e, t) {
    e.exports = function (e, t) {
        return function (r) {
    ...
    function n(e, t) {
        var r, n, o, i, s, a, u, l, c, p, f = 0, h = "FeatureCollection" === e.type, d = "Feature" === e.type,
            m = h ? e.features.length : 1;
        for (r = 0; r < m; r++) {
            for (a = h ? e.features[r].geometry : d ? e.geometry : e, l = h ? e.features[r].properties : d ? e.properties : {}, c = h ? e.features[r].bbox : d ? e.bbox : void 0, p = h ? e.features[r].id : d ? e.id : void 0, s = (u = !!a && "GeometryCollection" === a.type) ? a.geometries.length : 1, o = 0; o < s; o++) if (null !== (i = u ? a.geometries[o] : a)) switch (i.type) {
                case"Point":
                case"LineString":
                case"MultiPoint":
                case"Polygon":
                ...
                case"MultiPolygon":
                    if (!1 === t(i, f, l, c, p)) return !1;
                    break;
                case"GeometryCollection":
                    for (n = 0; n < i.geometries.length; n++) if (!1 === t(i.geometries[n], f, l, c, p)) return !1;
                    break;
                default:
                    throw new Error("Unknown Geometry Type")
            } else if (!1 === t(null, f, l, c, p)) return !1;
            f++
        }
    }
    ...
    function i(e, t) {
        ...
        r = function (e, r, n) {
            var o = 0;
            if (e.geometry) {
                var i, s = e.geometry.type;
                if ("Point" !== s && "MultiPoint" !== s) return !1 !== function e(t, r, n) {
                    if (null !== t) for (var o, i, s, a, u, l, c, p, f = 0, h = 0, d = t.type, m = "FeatureCollection" === d, y = "Feature" === d, v = m ? t.features.length : 1, g = 0; g < v; g++) {
                        u = (p = !!(c = m ? t.features[g].geometry : y ? t.geometry : t) && "GeometryCollection" === c.type) ? c.geometries.length : 1;
                        for (var b = 0; b < u; b++) {
                            var _ = 0, j = 0;
                            if (null !== (a = p ? c.geometries[b] : c)) {
                                ...
                                switch (f = !n || "Polygon" !== x && "MultiPolygon" !== x ? 0 : 1, x) {
                                    case null:
                                        break;
                                    case"Point":
                                        if (!1 === r(l, h, g, _, j)) return !1;
                                        h++, _++;
                                        break;
                                    case"LineString":
                                    case"MultiPoint":
                                        for (o = 0; o < l.length; o++) {
                                            if (!1 === r(l[o], h, g, _, j)) return !1;
                                            h++, "MultiPoint" === x && _++
                                        }
                                        "LineString" === x && _++;
                                        break;
                                    ...
                                    case"MultiPolygon":
                                        for (o = 0; o < l.length; o++) {
                                            for ("MultiPolygon" === x && (j = 0), i = 0; i < l[o].length; i++) {
                                                for (s = 0; s < l[o][i].length - f; s++) {
                                                    if (!1 === r(l[o][i][s], h, g, _, j)) return !1;
                                                    h++
                                                }
                                                j++
                                            }
                                        ...
                                        break;
                                    case"GeometryCollection":
                                        for (o = 0; o < a.geometries.length; o++) if (!1 === e(a.geometries[o], r, n)) return !1;
                                        break;
                                    default:
                                        throw new Error("Unknown Geometry Type")
                                }
                ...
                }(e, function (s, u, l, c, p) {
                    if (void 0 !== i) {
                        var f = Object(a.e)([i, s], e.properties);
                        if (!1 === t(f, r, n, p, o)) return !1;
                        o++, i = s
                    } else i = s
                }) && void 0
            }
        }, n(e, function (e, t, n, o, i) {
            ...
            switch (u) {
                ...
                case"LineString":
                case"Polygon":
                    return !1 !== r(Object(a.b)(e, n, {bbox: o, id: i}), t, 0) && void 0
            }
            switch (u) {
                case"MultiPoint":
                    s = "Point";
            ...
            for (var l = 0; l < e.coordinates.length; l++) {
                var c = {type: s, coordinates: e.coordinates[l]};
                if (!1 === r(Object(a.b)(c, n), t, l)) return !1
            }
        })
    }
    ...
    r(30);
    var o = n(r(31)), i = n(r(79)), s = n(r(80)), a = r(85), u = function (e) {
            if (e && e.__esModule) return e;
            var t = {};
            if (null != e) for (var r in e) Object.prototype.hasOwnProperty.call(e, r) && (t[r] = e[r]);
            return t.default = e, t
        }(a), l = n(r(86)), c = r(87), p = r(88),
        f = {imports: {numberFormat: c.numberFormat}, interpolate: /{{([\s\S]+?)}}/g},
        h = (0, o.default)(p.controlTemplate, f), d = (0, o.default)(p.resultsTemplate, f),
        m = (0, o.default)(p.pointPopupTemplate, f), y = (0, o.default)(p.linePopupTemplate, f),
        v = (0, o.default)(p.areaPopupTemplate, f);
    L.Control.Measure = L.Control.extend({
        ...
        _initLayout: function () {
            ...
            t.innerHTML = h({model: {className: e}}), t.setAttribute("aria-haspopup", !0), L.DomEvent.disableClickPropagation(t), L.DomEvent.disableScrollPropagation(t);
            var r = this.$toggle = (0, a.selectOne)(".js-toggle", t);
            this.$interaction = (0, a.selectOne)(".js-interaction", t);
            var n = (0, a.selectOne)(".js-start", t), o = (0, a.selectOne)(".js-cancel", t),
                i = (0, a.selectOne)(".js-finish", t);
            this.$startPrompt = (0, a.selectOne)(".js-startprompt", t), this.$measuringPrompt = (0, a.selectOne)(".js-measuringprompt", t), this.$startHelp = (0, a.selectOne)(".js-starthelp", t), this.$results = (0, a.selectOne)(".js-results", t), this.$measureTasks = (0, a.selectOne)(".js-measuretasks", t), this._collapse(), this._updateMeasureNotStarted(), L.Browser.android || (L.DomEvent.on(t, "mouseenter", this._expand, this), L.DomEvent.on(t, "mouseleave", this._collapse, this)), L.DomEvent.on(r, "click", L.DomEvent.stop), L.Browser.touch ? L.DomEvent.on(r, "click", this._expand, this) : L.DomEvent.on(r, "focus", this._expand, this), L.DomEvent.on(n, "click", L.DomEvent.stop), L.DomEvent.on(n, "click", this._startMeasure, this), L.DomEvent.on(o, "click", L.DomEvent.stop), L.DomEvent.on(o, "click", this._finishMeasure, this), L.DomEvent.on(i, "click", L.DomEvent.stop), L.DomEvent.on(i, "click", this._handleMeasureDoubleClick, this)
        },
        _expand: function () {
        ...
        _updateMeasureNotStarted: function () {
            u.hide(this.$startHelp), u.hide(this.$results), u.hide(this.$measureTasks), u.hide(this.$measuringPrompt), u.show(this.$startPrompt)
        },
        _updateMeasureStartedNoPoints: function () {
            u.hide(this.$results), u.show(this.$startHelp), u.show(this.$measureTasks), u.hide(this.$startPrompt), u.show(this.$measuringPrompt)
        },
        _updateMeasureStartedWithPoints: function () {
            u.hide(this.$startHelp), u.show(this.$results), u.show(this.$measureTasks), u.hide(this.$startPrompt), u.show(this.$measuringPrompt)
        },
        ...
        _getMeasurementDisplayStrings: function (e) {
            function t(e, t, o, i, s) {
                if (t && n[t]) {
                    var a = r(e, n[t], i, s);
                    return o && n[o] && (a = a + " (" + r(e, n[o], i, s) + ")"), a
                }
                return r(e, null, i, s)
            }

            function r(e, t, r, n) {
                var o = L.extend({factor: 1, decimals: 0}, t);
                return [(0, c.numberFormat)(e * o.factor, o.decimals, r || ",", n || "."), {
                    acres: "Acres",
                    feet: "Pés",
        ...
        _handleMeasureDoubleClick: function () {
            ...
            if (this._finishMeasure(), e.length) {
                ...
                o.innerHTML = r;
                var i = (0, a.selectOne)(".js-zoomto", o);
                ...
                var u = (0, a.selectOne)(".js-deletemarkup", o);
                u && (L.DomEvent.on(u, "click", L.DomEvent.stop), L.DomEvent.on(u, "click", function () {
        ...
        _handleMeasureClick: function (e) {
            var t = this._map.mouseEventToLatLng(e.originalEvent), r = this._latlngs[this._latlngs.length - 1],
        ...
        _addMeasureArea: function (e) {
            e.length < 3 ? this._measureArea && (this._layer.removeLayer(this._measureArea), this._measureArea = null) : this._measureArea ? this._measureArea.setLatLngs(e) : this._measureArea = L.polygon(e, this._symbols.getSymbol("measureArea")).addTo(this._layer)
        },
        _addMeasureBoundary: function (e) {
            e.length < 2 ? this._measureBoundary && (this._layer.removeLayer(this._measureBoundary), this._measureBoundary = null) : this._measureBoundary ? this._measureBoundary.setLatLngs(e) : this._measureBoundary = L.polyline(e, this._symbols.getSymbol("measureBoundary")).addTo(this._layer)
        }
    ...
    var n = r(32), o = r(62), i = r(65), s = r(66), a = r(67), u = r(22), l = r(15), c = r(68), p = r(25), f = r(71),
        h = r(26), d = /\b__p \+= '';/g, m = /\b(__p \+=) '' \+/g, y = /(__e\(.*?\)|\b__t\)) \+\n'';/g,
        v = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g, g = /($^)/, b = /['\n\r\u2028\u2029\\]/g;
    e.exports = function (e, t, r) {
        var _ = f.imports._.templateSettings || f;
        r && l(e, t, r) && (t = void 0), e = h(e), t = n({}, t, _, s);
        var j, x, M = n({}, t.imports, _.imports, s), w = c(M), O = i(M, w), L = 0, k = t.interpolate || g,
            P = "__p += '",
            C = RegExp((t.escape || g).source + "|" + k.source + "|" + (k === p ? v : g).source + "|" + (t.evaluate || g).source + "|$", "g"),
            E = "sourceURL" in t ? "//# sourceURL=" + t.sourceURL + "\n" : "";
        e.replace(C, function (t, r, n, o, i, s) {
            return n || (n = o), P += e.slice(L, s).replace(b, a), r && (j = !0, P += "' +\n__e(" + r + ") +\n'"), i && (x = !0, P += "';\n" + i + ";\n__p += '"), n && (P += "' +\n((__t = (" + n + ")) == null ? '' : __t) +\n'"), L = s + t.length, t
        }), P += "';\n";
        var S = t.variable;
        S || (P = "with (obj) {\n" + P + "\n}\n"), P = (x ? P.replace(d, "") : P).replace(m, "$1").replace(y, "$1;"), P = "function(" + (S || "obj") + ") {\n" + (S ? "" : "obj || (obj = {});\n") + "var __t, __p = ''" + (j ? ", __e = _.escape" : "") + (x ? ", __j = Array.prototype.join;\nfunction print() { __p += __j.call(arguments, '') }\n" : ";\n") + P + "return __p\n}";
        var A = o(function () {
            return Function(w, E + "return " + P).apply(void 0, O)
        });
        if (A.source = P, u(A)) throw A;
        return A
    }
}, function (e, t, r) {
    ...
    e.exports = function (e, t, r, i) {
        ...
        for (var a = -1, u = t.length; ++a < u;) {
            var l = t[a], c = i ? i(r[l], e[l], l, r, e) : void 0;
            void 0 === c && (c = e[l]), s ? o(r, l, c) : n(r, l, c)
        }
        return r
    }
}, function (e, t, r) {
    var n = r(8), o = r(6), i = Object.prototype.hasOwnProperty;
    e.exports = function (e, t, r) {
        var s = e[t];
    ...
    var n = r(10), o = r(40), i = r(2), s = r(42), a = /^\[object .+?Constructor\]$/, u = Function.prototype,
        l = Object.prototype, c = u.toString, p = l.hasOwnProperty,
    ...
    var n = r(4), o = Object.prototype, i = o.hasOwnProperty, s = o.toString, a = n ? n.toStringTag : void 0;
    e.exports = function (e) {
    ...
    var n, o = r(41), i = (n = /[^.]+$/.exec(o && o.keys && o.keys.IE_PROTO || "")) ? "Symbol(src)_1." + n : "";
    e.exports = function (e) {
        return !!i && i in e
    }
}, function (e, t, r) {
    ...
    var n = r(0), o = r(1), i = "[object Arguments]";
    e.exports = function (e) {
        return o(e) && n(e) == i
    }
}, function (e, t, r) {
    (function (e) {
        var n = r(5), o = r(55), i = "object" == typeof t && t && !t.nodeType && t,
            s = i && "object" == typeof e && e && !e.nodeType && e, a = s && s.exports === i ? n.Buffer : void 0,
    ...
    (function (e) {
        var n = r(11), o = "object" == typeof t && t && !t.nodeType && t,
            i = o && "object" == typeof e && e && !e.nodeType && e, s = i && i.exports === o && n.process,
            a = function () {
                try {
    ...
    var n = r(2), o = r(21), i = r(61), s = Object.prototype.hasOwnProperty;
    e.exports = function (e) {
        if (!n(e)) return i(e);
        var t = o(e), r = [];
    ...
    var n = r(0), o = r(64), i = r(1), s = "[object Object]", a = Function.prototype, u = Object.prototype,
        l = a.toString, c = u.hasOwnProperty, p = l.call(Object);
    e.exports = function (e) {
        if (!i(e) || n(e) != s) return !1;
        var t = o(e);
        if (null === t) return !0;
    ...
    var n = r(6), o = Object.prototype, i = o.hasOwnProperty;
    ...
    var n = r(18), o = r(69), i = r(7);
    e.exports = function (e) {
        return i(e) ? n(e) : o(e)
    }
}, function (e, t, r) {
    var n = r(21), o = r(70), i = Object.prototype.hasOwnProperty;
    e.exports = function (e) {
        if (!n(e)) return o(e);
        var t = [];
    ...
    var n = r(72), o = {escape: r(77), evaluate: r(78), interpolate: r(25), variable: "", imports: {_: {escape: n}}};
    e.exports = o
}, function (e, t, r) {
    var n = r(73), o = r(26), i = /[&<>"']/g, s = RegExp(i.source);
    e.exports = function (e) {
    ...
    var n = r(4), o = r(24), i = r(19), s = r(76), a = 1 / 0, u = n ? n.prototype : void 0, l = u ? u.toString : void 0;
    e.exports = function e(t) {
    ...
    var n = r(0), o = r(1), i = "[object Symbol]";
    e.exports = function (e) {
    ...
    function i(e, t, r) {
        var n = Math.abs(e), i = Math.floor(n), s = Math.floor(60 * (n - i)),
            a = Math.round(3600 * (n - i - s / 60) * 100) / 100, u = n === e ? t : r;
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.default = function (e) {
        var t = e[e.length - 1], r = e.map(function (e) {
                return [e.lat, e.lng]
            }), n = L.polyline(r), o = L.polygon(r), u = 1e3 * (0, s.default)(n.toGeoJSON(), {units: "kilometers"}),
            l = (0, a.default)(o.toGeoJSON());
        return {
    ...
    t.a = function (e, t, r) {
        ...
        var i = r.units, s = Object(n.a)(e), a = Object(n.a)(t), u = Object(o.a)(a[1] - s[1]),
            l = Object(o.a)(a[0] - s[0]), c = Object(o.a)(s[1]), p = Object(o.a)(a[1]),
            f = Math.pow(Math.sin(u / 2), 2) + Math.pow(Math.sin(l / 2), 2) * Math.cos(c) * Math.cos(p);
        return Object(o.g)(2 * Math.atan2(Math.sqrt(f), Math.sqrt(1 - f)), i)
    }
}, function (e, t, r) {
    "use strict";
    ...
    function o(e) {
        var t, r, n, o, s, u, l = 0, c = e.length;
        if (c > 2) {
            for (u = 0; u < c; u++) u === c - 2 ? (n = c - 2, o = c - 1, s = 0) : u === c - 1 ? (n = c - 1, o = 0, s = 1) : (n = u, o = u + 1, s = u + 2), t = e[n], r = e[o], l += (i(e[s][0]) - i(t[0])) * Math.sin(i(r[1]));
            l = l * a * a / 2
        }
        return l
    }
    ...
    "use strict";
    Object.defineProperty(t, "__esModule", {value: !0}), t.selectOne = function (e, t) {
        return t || (t = document), t.querySelector(e)
    }, t.selectAll = function (e, t) {
    ...
    }(), o = {activeColor: "#ABE67E", completedColor: "#C8F2BE"}, i = function () {
        function e(t) {
            (function (e, t) {
                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
            })(this, e), this._options = L.extend({}, o, this._options, t)
        }
    ...
    "use strict";
    Object.defineProperty(t, "__esModule", {value: !0}), t.numberFormat = function (e) {
        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 2,
            r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : ".",
            n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : ",", o = e < 0 ? "-" : "",
            i = Math.abs(+e || 0), s = parseInt(i.toFixed(t), 10) + "", a = s.length > 3 ? s.length % 3 : 0;
    ...
    e.exports = '<a class="{{ model.className }}-toggle js-toggle" href=# title="Mede distâncias e áreas">Medidas</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <h3>Mede distâncias e áreas</h3> <ul class=tasks> <a href=# class="js-start start">Criar nova medida</a> </ul> </div> <div class=js-measuringprompt> <h3>Mede distâncias e áreas</h3> <p class=js-starthelp>Comece criando uma medida, adicionando pontos no mapa</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Cancelar</a></li> <li><a href=# class="js-finish finish">Finalizar medida</a></li> </ul> </div> </div> '
}, function (e, t, r) {
    e.exports = '<div class=group> <p class="lastpoint heading">Último ponto</p> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> </div> <% if (model.pointCount > 1) { %> <div class=group> <p><span class=heading>Distância</span> {{ model.lengthDisplay }}</p> </div> <% } %> <% if (model.pointCount > 2) { %> <div class=group> <p><span class=heading>Área</span> {{ model.areaDisplay }}</p> </div> <% } %> '
}, function (e, t, r) {
    e.exports = '<h3>Localização do ponto</h3> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centralizar nesta localização</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Excluir</a></li> </ul> '
}, function (e, t, r) {
    e.exports = '<h3>Medida linear</h3> <p>{{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centralizar nesta linha</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Excluir</a></li> </ul> '
}, function (e, t, r) {
    e.exports = '<h3>Medida de área</h3> <p>Área - {{ model.areaDisplay }}</p> <p>Perímetro - {{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centralizar nesta área</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Excluir</a></li> </ul> '
}]);